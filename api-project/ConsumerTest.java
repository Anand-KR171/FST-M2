...
public class ConsumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        DslPart reqResBody = new PactDslJsonBody()
                .numberType("id", 123)
                .stringType("firstName", "anand")
                .stringType("lastName", "kr")
                .stringType("email", "anankr@gmail.com");
    ...
    public void consumerTest() {
        ...
        reqBody.put("id", 123);
        reqBody.put("firstName", "anand");
        reqBody.put("lastName", "kr");
        reqBody.put("email", "anankr@gmail.com");
